...
resource "aws_instance" "tf-docker-ec2" {
    ...
    key_name = "eba-nv"
    security_groups = ["ebu-docker-sec-gr"]
    tags = {
      "name" = "ebubekir service of bookstore"
    }
    user_data = <<-EOF
          #! /bin/bash
          yum update -y
          ...
          TOKEN="ADD TOKEN"
          FOLDER="https://$TOKEN@raw.githubusercontent.com/ebagovtere/bookstore-repo/main/"
...
resource "aws_security_group" "ebu-docker-sec-gr" {
    name = "ebu-docker-sec-gr"
tags = {
